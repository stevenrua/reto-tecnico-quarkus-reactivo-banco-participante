...
public enum ErrorCode {
    ...
    ERROR_U01_ALIAS_REGISTERED("ERR-U00: Lo sentimos ese alias ya se encuentra registrado en nuestro sistema"),
    ERROR_U00_INVALID_FORMAT_ALIAS("ERR-U01: El alias(telefono) debe cumplir con el formato panameño, debe empezar con 6 y contener 8 digitos");
